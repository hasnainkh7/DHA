            ...
            <div class="col-4 col-sm-2">
                ...
                <div class="card avtivity-card">
                    <div class="card-body">
                        <div class="media align-items-center">
                            <div class="media-body text-center">
                                <span class="title text-black font-w600">AD</span>
                            </div>
                        </div>
                    </div>
                    <div class="effect bg-success"></div>
            ...
            <div class="col-4 col-sm-2">
                ...
                <div class="card avtivity-card">
                    <div class="card-body">
                        <div class="media align-items-center">
                            <div class="media-body text-center">
                                <span class="title text-black font-w600">AE</span>
                            </div>
                        </div>
                    </div>
                    <div class="effect bg-success"></div>
            ...
            <div class="col-4 col-sm-2">
                ...
                <div class="card avtivity-card">
                    <div class="card-body">
                        <div class="media align-items-center">
                            <div class="media-body text-center">
                                <span class="title text-black font-w600">AF</span>
                            </div>
                        </div>
                    </div>
                    <div class="effect bg-success"></div>
